/**
 * Moteur de texture du Studio.
 *
 * Une référence de parquet n'est plus « une teinte » : c'est un matériau
 ...
 *
 * La tuile produite est répétable (raccord invisible) : on la projette
 * ensuite sur le sol de la photo par homographie, comme une seule et même
 * surface continue.
 */
...
export function buildTexture(material, { pattern = 'lames', width, size = TILE } = {}) {
  ...
  const widthM = width || material.boardWidth;
